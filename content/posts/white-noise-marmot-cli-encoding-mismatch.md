...
I've [written before](/posts/simplex-chat-contribution/) about privacy-focused messaging and why protocols like SimpleX deserve more attention beyond person-to-person chat. I even submitted a [PR](https://github.com/simplex-chat/simplex-chat/pull/6609) to make SimpleX's CLI more useful for containerised deployments and automation — allowing the WebSocket server to bind to more than just localhost. Six weeks later, no review, no comment. SimpleX is excellent software, but the project's focus is clearly on the mobile app experience. Building an AI agent on top of it would mean maintaining a patched fork indefinitely. Not a path I wanted to go down.
